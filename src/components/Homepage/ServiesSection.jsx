...
const services = {
  "Wash & Fold": {
    ...
    image: "Yizzy/src/assets/Servicesections/wash.png",
  },
  "Dry Cleaning": {
    title: "Dry Cleaning",
    description:
    ...
    image: "Yizzy/src/assets/Servicesections/Dry.png",
  },
  "Other Services": {
    title: "Self Service",
    ...
    image: "Yizzy/src/assets/Servicesections/Selfservice.png",
  },
};
        ...
        {Object.keys(services).map((service) => (
          <button
            ...
            className={`px-4 py-2 transition duration-300 border-b-2 ${
              selectedService === service ? "border-pink-500 text-pink-600" : "border-transparent hover:border-gray-400"
            }`}
          >
            {service}
          </button>
